...
print "Michigan has: {}".format(hashmap.get(cities,
                                            hashmap.get(states, 'Michigan')))
print "Florida has: {}".format(hashmap.get(cities,
                                           hashmap.get(states, 'Florida')))
...
# one line
print "The city for the state 'TX' is: {}".format(hashmap.get(cities,
                                                              'TX',
                                                              'Does Not Exist'))
